...
6. `directPay()` - 12 edges
7. `notFound()` - 11 edges
8. `compilerOptions` - 11 edges
9. `initMerchAdmin()` - 10 edges
10. `adminLogin()` - 10 edges
...
Cohesion: 0.08
Nodes (74): adminCollect(), adminCreateMerch(), adminDeleteMerch(), adminDeleteOrder(), adminListMerch(), adminListOrders(), adminLogin(), adminLogout() (+66 more)
